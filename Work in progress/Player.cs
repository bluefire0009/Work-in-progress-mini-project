public class Player
{
    ...
    public List<Item> Inventory { get; set; } // Assuming Item is a class representing inventory items
    ...
    public void AcceptQuest(Quest quest)
    {
        if (!AcceptedQuests.Contains(quest))
        {
            ...
            Console.WriteLine($"{quest.Name} has been added to your quests.");
        }
    }
    ...
    public void CompleteQuest(Quest quest)
    {
        if (AcceptedQuests.Contains(quest))
        {
            ...
            Console.WriteLine($"{quest.Name} has been completed.");
        }
    }
}